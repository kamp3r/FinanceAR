...
function animarLinks(link, haciaDonde) {
	link.click(function (e) {
		...
		$('html, body').animate(
			{
				scrollTop: haciaDonde.offset().top,
			},
			2000
		);
	});
...
animarLinks($('#alSimulador'), $('#contenedorSimulador'));

//paso 1 a 2
function nextBackFormulario(
	boton,
	primerFormulario,
	segundoFormulario,
	width,
...
nextBackFormulario(
	...
	'23%',
	$(".paso1"),
	'invert(0) sepia(8) saturate(30) hue-rotate(260deg)',
	'1'
);
nextBackFormulario(
	$('#anterior0'),
	...
	'-23%',
	$('.paso1'),
	'invert(0) sepia(8) saturate(0) hue-rotate(260deg)',
	'0.9'
);
...
$('#paso-4').validate({
	...
	messages: {
		monto:
			'El campo es obligatorio. Recorda que aprobamos prestamos hasta $999.999 pesos',
...
$('#botonEnviar').on('click', () => {
	...
	$('#progreso').width('0%');
	$('.paso1').css({
		filter: 'invert(0) sepia(8) saturate(0) hue-rotate(260deg)',
		opacity: '0.9',
	});
	$('.paso2').css({
		filter: 'invert(0) sepia(8) saturate(0) hue-rotate(260deg)',
